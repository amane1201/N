...
var MEMBERS_DATA = [
  ...
  },
  {
    ...
    name:"Exat",
    title_ja:"政治局長",
    title_en:"politischer Direktor",
    role:"political director",
    description:"政治局員を統括し、政策の立案と実行を監督する。",
    color:"#ff3935",
    img:"assets/members/Exat.png"
  }
];
...
var NEWS_DATA = [
  {
    date:"2026-05-04",
    title:"帝国樹立",
    content:"中央荒らし大帝国の創設者であるやまだが、新たな国家の誕生を宣言しました。"
  },
];
...
function initBoot(){
  ...
  var lines = [
    ...
    ["<span style='color:#00e0ff'>[0.43]</span>","LOADING CHUO_ARASHI_OS v9.7.4"],
